...
int main()
{
    ...
    Circle* circle8 = new Circle(4.0); // heap memory

    cout << circle8->getRadius() << endl;

    delete circle8; // delete하는 시점에 소멸자가 실행된다.
    circle8 = nullptr;
    cout << Circle::getCount() << endl;
    ...
    Circle* circleCopy = test();
    circleCopy->setRadius(10.0);
